...
func PredicateTableExists(c *db.Connection, tx *db.Tx, tableName string) (bool, error) {
...
func PredicateTableExistsInSchema(c *db.Connection, tx *db.Tx, schemaName, tableName string) (bool, error) {
...
func PredicateColumnExists(c *db.Connection, tx *db.Tx, tableName, columnName string) (bool, error) {
...
func PredicateColumnExistsInSchema(c *db.Connection, tx *db.Tx, schemaName, tableName, columnName string) (bool, error) {
...
func PredicateConstraintExists(c *db.Connection, tx *db.Tx, tableName, constraintName string) (bool, error) {
...
func PredicateConstraintExistsInSchema(c *db.Connection, tx *db.Tx, schemaName, tableName, constraintName string) (bool, error) {
	return c.Invoke(db.OptTx(tx)).Query(
...
func PredicateIndexExists(c *db.Connection, tx *db.Tx, tableName, indexName string) (bool, error) {
...
func PredicateIndexExistsInSchema(c *db.Connection, tx *db.Tx, schemaName, tableName, indexName string) (bool, error) {
	return c.Invoke(db.OptTx(tx)).Query(
...
func PredicateRoleExists(c *db.Connection, tx *db.Tx, roleName string) (bool, error) {
